...
codes = []
# code piece
for sequential search(you can change it to other code if you want)
code = """def sequentialSearch(alist, item):
    ...
    while pos < len(alist) and not found:
        if alist[pos] == item:
            ...
            pos = pos+1
    return found"""
# use your own strategies to generate initial code pieces as the parents here
#I just randomly add three original code pieces as the parents
#seed(Selfingbreeding.....)
codes.append(code);
codes.append(code);
codes.append(code);
print(codes)
